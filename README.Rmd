...
* `trakt_username` **Optional**. For functions that pull a user's watched shows or stats (`trakt.user.*`), this just sets the default value so you don't have to keep supplying it in individual function calls.
