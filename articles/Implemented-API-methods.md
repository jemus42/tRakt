...
This is a reference list of [trakt.tv API
methods](https://trakt.docs.apiary.io/) tracked by this package, their
endpoint URLs (with user-specified parameters indicated by a `:` prefix)
and their implementation status. Methods with an implementation link are
available in this package; blank entries are tracked but not yet
implemented. Authenticated methods are indicated as such.

Write-only endpoints (creating/updating/deleting items, scrobbling,
check-ins) are omitted as they are outside the scope of this package.
...
| Favorited    | [/movies/favorited/:period](https://trakt.docs.apiary.io/#reference/movies/favorited/get-the-most-favorited-movies)           |                                                                                            | Optional |
...
| Studios      | [/movies/:id/studios](https://trakt.docs.apiary.io/#reference/movies/studios/get-movie-studios)                               |                                                                                            | Optional |
...
| Favorited           | [/shows/favorited/:period](https://trakt.docs.apiary.io/#reference/shows/favorited/get-the-most-favorited-shows)                                                              |                                                                                           | Optional |
...
| Certifications      | [/shows/:id/certifications](https://trakt.docs.apiary.io/#reference/shows/certifications/get-all-show-certifications)                                                         |                                                                                           | Optional |
...
| Studios             | [/shows/:id/studios](https://trakt.docs.apiary.io/#reference/shows/studios/get-show-studios)                                                                                  |                                                                                           | Optional |
...
| Translations | [/shows/:id/seasons/:season/translations/:language](https://trakt.docs.apiary.io/#reference/seasons/translations/get-all-season-translations) |                                                                                       | Optional |
...
| Method     | Endpoint                                                                                                                       | Implementation                                                                    | Auth     |
|:-----------|:-------------------------------------------------------------------------------------------------------------------------------|:----------------------------------------------------------------------------------|:---------|
| Updates    | [/people/updates/:start_date](https://trakt.docs.apiary.io/#reference/people/updates/get-recently-updated-people)              |                                                                                   | Optional |
| Updates Id | [/people/updates/id/:start_date](https://trakt.docs.apiary.io/#reference/people/updates/get-recently-updated-people-trakt-ids) |                                                                                   | Optional |
...
| Notes               | [/users/:id/notes/:type](https://trakt.docs.apiary.io/#reference/users/notes/get-notes)                                            |                                                                                           | Optional |
...
| List Collaborations | [/users/:id/lists/collaborations](https://trakt.docs.apiary.io/#reference/users/lists/get-all-lists-a-user-can-collaborate-on)     |                                                                                           | Optional |
...
| List Likes          | [/users/:id/lists/:list_id/likes](https://trakt.docs.apiary.io/#reference/users/list-likes/get-all-users-who-liked-a-list)         |                                                                                           | Optional |
...
| Watchlist Comments  | [/users/:id/watchlist/comments/:sort](https://trakt.docs.apiary.io/#reference/users/watchlist-comments/get-all-watchlist-comments) |                                                                                           | Optional |
| Favorites           | [/users/:id/favorites/:type/:sort_by/:sort_how](https://trakt.docs.apiary.io/#reference/users/favorites/get-favorites)             |                                                                                           | Optional |
| Favorites Comments  | [/users/:id/favorites/comments/:sort](https://trakt.docs.apiary.io/#reference/users/favorites-comments/get-all-favorites-comments) |                                                                                           | Optional |
| Watching            | [/users/:id/watching](https://trakt.docs.apiary.io/#reference/users/watching/get-watching)                                         |                                                                                           | Optional |
...
| Comments | [/lists/:id/comments/:sort](https://trakt.docs.apiary.io/#reference/lists/comments/get-all-list-comments)            |                                                                                  | Optional |

## Recommendations

| Method | Endpoint                                                                                                            | Implementation | Auth     |
|:-------|:--------------------------------------------------------------------------------------------------------------------|:---------------|:---------|
| Movies | [/recommendations/movies](https://trakt.docs.apiary.io/#reference/recommendations/movies/get-movie-recommendations) |                | Required |
| Shows  | [/recommendations/shows](https://trakt.docs.apiary.io/#reference/recommendations/shows/get-show-recommendations)    |                | Required |
