...
#> 1 5.79e17 show  Utopia …  2014 A blur… Set ins…      25 au      https:… https:/…
...
#> #   aired_episodes <int>, network <chr>, certification <chr>, airs_day <chr>,
...
movies_watched(period = "yearly", filters = filters_movies(years = c(1990, 2000))) |>
  select(watcher_count, title, year)
#> # A tibble: 10 × 3
#>    watcher_count title                     year
#>            <int> <chr>                    <int>
#>  1          2480 Toy Story                 1995
#>  2          2003 Toy Story 2               1999
#>  3           911 Fight Club                1999
#>  4           871 The Matrix                1999
#>  5           778 The Lion King             1994
#>  6           762 Titanic                   1997
#>  7           759 The Shawshank Redemption  1994
#>  8           728 Forrest Gump              1994
#>  9           711 The Truman Show           1998
#> 10           695 Se7en                     1995
```
