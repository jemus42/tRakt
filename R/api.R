...
#' To make this work automatically, place a `key.json` file either in the working directory
#' or in `~/.config/trakt/key.json`.
...
#' @param set.headers `TRUE` by default. Sets the `httr` headers
#' for `GET` requests for the APIv2
