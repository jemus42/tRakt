...
<!-- WARNING: show-analysis-24.Rmd is generated from show-analysis-24.Rmd.orig. -->
<!-- Please edit that file, then re-knit it with vignettes/precompile.R. -->
...
<div class="figure">
<img src="figures/24-episodes-plot-1.png" alt="plot of chunk 24-episodes-plot" width="100%" />
<p class="caption">plot of chunk 24-episodes-plot</p>
</div>
