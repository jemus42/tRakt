...
`movies_trending()` wraps endpoint
[/movies/trending](https://trakt.docs.apiary.io/#reference/movies/trending/get-trending-movies).

`shows_trending()` wraps endpoint
[/shows/trending](https://trakt.docs.apiary.io/#reference/shows/trending/get-trending-shows).
