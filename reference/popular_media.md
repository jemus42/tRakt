...
`movies_popular()` wraps endpoint
[/movies/popular](https://trakt.docs.apiary.io/#reference/movies/popular/get-popular-movies).

`shows_popular()` wraps endpoint
[/shows/popular](https://trakt.docs.apiary.io/#reference/shows/popular/get-popular-shows).
...
- Popular: Popularity is calculated using the rating percentage and the
  number of ratings.
