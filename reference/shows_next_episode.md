...
`shows_next_episode()` wraps endpoint
[/shows/:id/next_episode](https://trakt.docs.apiary.io/#reference/shows/next-episode/get-next-episode).

`shows_last_episode()` wraps endpoint
[/shows/:id/last_episode](https://trakt.docs.apiary.io/#reference/shows/last-episode/get-last-episode).
