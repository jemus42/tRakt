...
`movies_collected()` wraps endpoint
[/movies/collected/:period](https://trakt.docs.apiary.io/#reference/movies/collected/get-the-most-collected-movies).

`shows_collected()` wraps endpoint
[/shows/collected/:period](https://trakt.docs.apiary.io/#reference/shows/collected/get-the-most-collected-shows).
...
- Collected: Returns the most collected (unique users) movies/shows in
