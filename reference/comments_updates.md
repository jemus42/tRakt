...
`comments_updates()` wraps endpoint
[/comments/updates/:comment_type/:type?include_replies=](https://trakt.docs.apiary.io/#reference/comments/updates/get-recently-updated-comments).
